defmodule Mjw.Games.BotStrategyTest do
  ...
  describe "draw" do
    test "chooses discard if it can win the game" do
      ...
      assert Mjw.Games.BotStrategy.draw(game) == :win_with_discard
    end
    ...
    test "chooses discard if it can complete a run" do
      ...
      assert Mjw.Games.BotStrategy.draw(game) ==
    ...
    test "chooses deck tile if the discard is not desirable" do
      ...
      assert Mjw.Games.BotStrategy.draw(game) == :zimo
    end
    ...
    test "wins with deck tile if the discard is not desirable and it completes a winning hand" do
      ...
      assert Mjw.Games.BotStrategy.draw(game) == :draw_deck_tile
    end
  end
  ...
  describe "discard" do
    test "discards non-numeric tiles first" do
      ...
      assert Mjw.Games.BotStrategy.discard(game) == "wn-0"
    end
    ...
    test "if all tiles are numeric, discards tiles that aren't contiguous with other tiles" do
      ...
      assert Mjw.Games.BotStrategy.discard(game) == "n1-1"
    end
    ...
    test "if all tiles are numeric and contiguous, discards a tile with a sibling" do
      ...
      assert Mjw.Games.BotStrategy.discard(game) in ["b2-1", "b2-2", "c4-0", "c4-1"]
    end
    ...
    test "if all tiles are numeric and contiguous and no siblings, discards rarest suit" do
      ...
      assert Mjw.Games.BotStrategy.discard(game) == "n1-2"
    end
    ...
    test "concealed hand of 2 discards the rarest one in discards" do
      ...
      assert Mjw.Games.BotStrategy.discard(game) == "n1-3"
    end
    ...
    test "concealed hand of 5 preserves a pair" do
      ...
      assert Mjw.Games.BotStrategy.discard(game) == "b4-2"
    end
    ...
    test "concealed hand of runs + 5 preserves a pair" do
      ...
      assert Mjw.Games.BotStrategy.discard(game) == "b1-0"
    end
  end
  ...
  describe "find_win_out_of_turn" do
    test "finds no wins if no bots available out of turn" do
      ...
      assert Mjw.Games.BotStrategy.find_win_out_of_turn(game) == :no_wins
    end
    ...
    test "finds a win" do
      ...
      assert Mjw.Games.BotStrategy.find_win_out_of_turn(game) == {:ok, 0}
    end
  end
end
